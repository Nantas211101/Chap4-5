#include "../include/CLL.hpp"
const std::string Name = "Circular Link List";
...
void CLL::setStateButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
...
void CLL::setLabel(Context context, int posx, int posy, const std::string &text, int sizeoftext){
...
void CLL::setInputButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
