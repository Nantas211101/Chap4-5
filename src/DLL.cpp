...
const std::string Name = "Doubly Link List";
...
void DLL::setStateButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
...
void DLL::setLabel(Context context, int posx, int posy, const std::string &text, int sizeoftext){
...
void DLL::setInputButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
