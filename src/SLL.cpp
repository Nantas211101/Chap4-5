...
const std::string Name = "Singly Link List";
...
void SLL::setStateButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
...
void SLL::setLabel(Context context, int posx, int posy, const std::string &text, int sizeoftext){
...
void SLL::setInputButton(Context context, int posx, int posy, const std::string &text, std::function<void()> action){
