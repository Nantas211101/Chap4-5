...
void DynamicArray::resetButton(int size, bool isResetInputButton) {
...
bool DynamicArray::checkInputError(inputID::ID kind, int p) {
    if (kind == inputID::Pos) {
...
void DynamicArray::searchingNode(sf::Time dt, const sf::Event& event) {
    if (usingData1 == "")
        usingData1 = data[0];
...
void DynamicArray::accessingNode(sf::Time dt, const sf::Event& event) {
    if (usingData1 == "")
        usingData1 = data[0];
    int id = toNum(usingData1);
...
void DynamicArray::updatingNode(sf::Time dt, const sf::Event& event) {
    if (usingData1 == "") {
        usingData1 = data[0];
        usingData2 = data[1];
    }
